...
object MonoidEx4Spec 
  ...
  property("Ex04.05: optionMonoid is a monoid") =
    given Arbitrary[Boolean] = Arbitrary(Arbitrary.arbitrary[Boolean].sample.getOrElse(false))
    optionMonoid.laws.monoid

  property("Ex04.06: optionMonoidLift is a monoid") =
    given Monoid[Int] = intAddition
    given Arbitrary[Int] = Arbitrary(Arbitrary.arbitrary[Int].sample.getOrElse(0))
...
object MonoidEx7Spec 
  ...
  property("Ex07.01: stringMonoid is isomorphic to listMonoid[Char]") =
    given Arbitrary[String] = Arbitrary(Arbitrary.arbitrary[String].sample.getOrElse(""))
    given Arbitrary[List[Char]] = Arbitrary(Arbitrary.arbitrary[List[Char]].sample.getOrElse(Nil))
